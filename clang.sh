...
mkdir $ClangPath
rm -rf $ClangPath/*
wget -q  https://github.com/ZyCromerZ/Clang/releases/download/15.0.0-20220227-release/Clang-15.0.0-20220227.tar.gz -O "Clang-15.0.0-20220227.tar.gz"
tar -xf Clang-15.0.0-20220227.tar.gz -C $ClangPath
