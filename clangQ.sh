...
mkdir $ClangPath
rm -rf $ClangPath/*
wget -q  https://github.com/ZyCromerZ/Clang/releases/download/14.0.0-20220306-release/Clang-14.0.0-20220306.tar.gz -O "Clang-14.0.0-20220306.tar.gz"
tar -xf Clang-14.0.0-20220306.tar.gz -C $ClangPath
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 [$DATE2][Q-OSS]$KERNEL_NAME[$DEVICE_CODENAME]${DATE}.zip *
    cd ..
}
compile
zipping
